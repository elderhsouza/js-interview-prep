...
export function getMaxProfit1(prices: readonly number[]): number {
...
export function getMaxProfit2(prices: readonly number[]): number {
...
export function getMaxProfit3(prices: readonly number[]): number {
  return prices.reduce(
    ({ minBuy, maxProfit }, currentPrice) => {
      return {
