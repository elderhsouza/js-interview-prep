...
Output: String
*/
export function highestFrequency(stringArray) {
    const frequencies = {};
    let maxFrequency = 0;
...
//---
export function modernHighestFrequency(stringArray) {
    return stringArray
        .reduce((acc, str) => {
        acc.frequencies.set(str, acc.frequencies.has(str) ? (acc.frequencies.get(str) + 1) : 1);
...
//# sourceMappingURL=highest-frequency.js.map