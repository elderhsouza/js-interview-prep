...
*/
export function rotateClockWise1(matrix) {
...
//---
export function rotateClockWise2(matrix) {
    return matrix.reduce((reduced, row) => {
...
//---
export function rotateClockWise3(matrix) {
    return matrix.reduce((rotated, _, rowIndex) => {
...
//# sourceMappingURL=rotate-matrix.js.map